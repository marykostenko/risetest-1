...
public class PayServiceFeeTest extends BaseTest
{
    ...
    public void testSuccessfulPayment() throws IOException, InterruptedException, MessagingException, SQLException {
        ...
        String randomEmail = testUserData.creationTestCandidateForPayFee((getStandUrl("Ext")), regUsData.getUserLastName(), regUsData.getUserFirstName(),
                regUsData.getSexEn(),regUsData.getCountryId(), regUsData.getUserPassword(), regUsData.getPlaceOfBirth(),
                regUsData.getDateOfBirth(), regUsData.getSexEn(), regUsData.getLvlId(), regUsData.getPreviousEduOrganization(),
                regUsData.getCountryOfFinishedEducationOrganisationId(), regUsData.getSourceOfSearch(), regUsData.getCandidateFormAndCardTpl(), regUsData.getNationalSelectionId(),
                regUsData.getAgreeToContract(), regUsData.getEduDirId(), regUsData.getEduDirId(), regUsData.getEducationForm(), regUsData.getLanguagesWithDegreesDegree(),
                regUsData.getLanguagesWithDegreesDegree(), regUsData.getLanguagesWithDegreesLanguage(), regUsData.getSelectedOrgId(), regUsData.getDocumentOfPassportId(),
                regUsData.getDocumentCopyOfTheEduCertificate());
