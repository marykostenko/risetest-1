...
public class PayServiceFeeTest extends BaseTest
{
    ...
    public void testSuccessfulPayment() throws IOException, InterruptedException, MessagingException {
        ...
        testUserData.registrationCandidateForPayFeeTest(userDataForPayFeeRandomEmail.getUserForPayFeeRandomEmail(),userDataForPayFee.getUserLastName(), userDataForPayFee.getUserFirstName(), userDataForPayFee.getSexRu(), userDataForPayFee.getCountry(),
