...
public class PagePasswordRecovery extends BasePage {
    ...
    public int checkNewPasswordRed(int logErrors)
   {
     ...
     * голубой алерт
     */
    private ElementsCollection alertUndefined = $$(By.xpath("//div[@class = 'alert undefined']"));
     ...
     * зеленый алерт
     */
    private ElementsCollection alertSuccess = $$(By.xpath("//div[@class = 'alert alert-success']"));
